...
{
    public partial class VerticalLayoutView : UserControl, IMainLayoutView
    {
        ...
        private void GridViewColumnHeaderClicked(object sender, RoutedEventArgs e)
        {
            ...
            {
                // Note: Header might be a string or content.
                // Assuming string for now based on XAML.
                // If Localization updates headers, this logic might need `Tag` or Index matching.
                // Index: 0=Name, 1=Date, 2=Type, 3=Size
        ...
        // ... (Skipping event handlers usually unchanged) ... but I need to update HeaderClicked if line numbers changed significantly?
        // Actually I can rewrite the whole file methods needed.
        ...
        public void UpdateSortVisuals(AppConstants.SortTarget target, AppConstants.SortDirection direction)
        {
            ...
            // Mapping: 0=Name, 1=Size, 2=Date, 3=Type, 4=Owner
